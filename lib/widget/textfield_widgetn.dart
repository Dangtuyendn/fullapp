...
class TextFieldWidgetN extends StatelessWidget {
  final String? lableText;
  final String hinText;
  final String textTitle;
  final TextEditingController? textcontroller;
  final Widget? widget;
  const TextFieldWidgetN(
      {this.lableText,
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            margin: const EdgeInsets.only(top: padingRow),
            height: h / 14,
                ...
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText: hinText,
                      hintStyle: TextStyles.defaultStyle.ggfontblack16,
                      // hintText: hinText,
